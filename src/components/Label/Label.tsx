...
const Label: FunctionComponent<Props> = ({ children, color, className }) => {
  
  return (
    <>
      <div
        tw="max-w-max flex items-center justify-between py-1 px-3 rounded-full last:mr-0 mr-1 transition-all duration-300 "
        className={`${bgColors[color] || ""}${className || ""}`}
      >
        <span
